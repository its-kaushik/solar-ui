...
<Callout type="info">
On-grid systems are the best choice for most Delhi homeowners. They're affordable, subsidy-eligible, and the net metering policy from BSES is very favorable.
</Callout>
...
**Choose On-Grid if:**
- You have reliable power supply (Delhi, most urban areas)
